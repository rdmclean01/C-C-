 ...
 *      Author: Ryan McLean
 *      I ended with a period of 50ms
 *      Total time spent on this lab was about 15 hrs
 *      Main problems were with malloc returning NULL pointer
 *      and moles not printing being erased when whacked
 */
